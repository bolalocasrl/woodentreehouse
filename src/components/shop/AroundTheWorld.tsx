...
export default function AroundTheWorld({ posts }: { posts: PostMondo[] }) {
  ...
  return (
    <section className="border-t border-brand-smoke/20 bg-brand-forest text-brand-offwhite">
      ...
      <div className="flex overflow-x-auto snap-x snap-mandatory gap-4 px-6 pb-10 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden sm:grid sm:grid-cols-2 lg:grid-cols-4 sm:gap-6 sm:overflow-visible md:px-16">
        {visibili.map((post, i) => (
          <motion.a
            ...
            className="group block flex-none w-[78vw] snap-center sm:w-auto bg-white text-brand-smoke border border-brand-smoke/10 shadow-sm hover:shadow-xl transition-shadow duration-500"
