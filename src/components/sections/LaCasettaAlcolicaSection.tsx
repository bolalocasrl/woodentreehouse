...
import imgIRagazzi from "@/assets/images/iragazzi.jpg";
...
import imgAlcolicaSgp from "@/assets/images/alcolicasgp.jpg";
import imgAlcolicaCasetta from "@/assets/images/alcolicacasetta.jpg";
import imgCas1 from "@/assets/images/cas1.jpg";
import imgCas2 from "@/assets/images/cas2.jpg";
import imgCas3 from "@/assets/images/cas3.jpg";

const alcolicaImages = [
  { src: imgIRagazzi, alt: "La Casetta Alcolica" },
  { src: imgTrasportoAlcolica, alt: "La Casetta Alcolica" },
  { src: imgCasettaAlcolica, alt: "La Casetta Alcolica" },
  { src: imgCas1, alt: "La Casetta Alcolica" },
  { src: imgCas2, alt: "La Casetta Alcolica" },
  { src: imgCas3, alt: "La Casetta Alcolica" },
  { src: imgAlcolicaSgp, alt: "La Casetta Alcolica" },
  { src: imgAlcolicaCasetta, alt: "La Casetta Alcolica" },
];

export function LaCasettaAlcolicaSection() {
  ...
  return (
    <section id="casetta-alcolica" className="py-20 md:py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-serif font-bold text-brand-green mb-6">La Casetta Alcolica</h2>
        ...
        >
          ...
          <Button
            data-testid="button-prev-casetta-alcolica"
            variant="ghost"
            size="icon"
          ...
          <Button
            data-testid="button-next-casetta-alcolica"
            variant="ghost"
            size="icon"
